...
export default function AdminDashboardPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Sección de Activación de Pólizas */}
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-foreground border-b pb-2">Activación de Pólizas</h3>
      ...
      {/* Sección de Cargas de Fábricas */}
      <div className="space-y-4">
        <h3 className="text-lg font-semibold text-foreground border-b pb-2">Cargas de Fábricas</h3>
        <div className="grid gap-6 md:grid-cols-2">
